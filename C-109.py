...
print("{}% of data lies within one standard deviation", format(len(list_of_data_within_2_std_deviation)*100.0/len(dice_result)))
print("{}% of data lies within one standard deviation", format(len(list_of_data_within_3_std_deviation)*100.0/len(dice_result)))
